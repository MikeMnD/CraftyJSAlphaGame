Crafty.c("MoveTo", {
    ...
    _enterFrame: function () {
        ...
        // Pixels to move are calculated from location and target every frame to handle the case when something else 
        // (IE, collision detection logic) changes our position.
